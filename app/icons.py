...
entry is the inner markup of a ``viewBox="0 0 24 24"`` stroke icon; colour
is inherited from the CSS ``color`` of the wrapping element via
``stroke="currentColor"``. Exposed to templates as the ``icon()`` global.
"""
